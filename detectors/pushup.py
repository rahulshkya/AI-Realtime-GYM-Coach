...
class PushUpDetector(BaseExercise):
    ...
    def process(self,landmarks) -> dict:
        ...
        hip_drift=abs(hip_y-expected_hip_y)

        key_landmarks_visible=landmarks[shoulder_idx].visibility > self.MIN_VISIBILITY and landmarks[elbow_idx].visibility > self.MIN_VISIBILITY and landmarks[wrist_idx].visibility > self.MIN_VISIBILITY and landmarks[hip_idx].visibility > self.MIN_VISIBILITY and landmarks[ankle_idx].visibility > self.MIN_VISIBILITY
        ...
        if hip_drift <= self.HIP_SAG_TOLERANCE:
            hip_status = "Level"

        elif hip_drift > self.HIP_SAG_TOLERANCE:
            hip_status = "Sagging"
